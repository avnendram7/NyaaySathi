...
import { Scale, Search, Filter, Star, Briefcase, MapPin, ArrowRight, X, ChevronDown, ChevronLeft, ChevronRight, CheckCircle } from 'lucide-react';
...
const BrowseLawyers = () => {
  ...
  const filteredLawyers = useMemo(() => {
    return dummyLawyers.filter(lawyer => {
      ...
      // Rating filter
      if (filters.ratingMin && lawyer.rating < parseFloat(filters.ratingMin)) {
        return false;
      }
