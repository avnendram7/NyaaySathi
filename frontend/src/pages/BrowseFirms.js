...
import { Scale, Search, Filter, Star, Building2, MapPin, Users, Calendar, ArrowRight, ChevronLeft, ChevronRight, CheckCircle } from 'lucide-react';
...
const BrowseFirms = () => {
  ...
  const filteredFirms = useMemo(() => {
    return dummyLawFirms.filter(firm => {
      ...
      // Rating filter
      if (filters.ratingMin && firm.rating < parseFloat(filters.ratingMin)) {
        return false;
      }
