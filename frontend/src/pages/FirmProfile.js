...
import { 
  Scale, Star, Building2, MapPin, ArrowRight, ArrowLeft, Phone, Mail, 
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  ...
                  <span className="px-3 py-1 bg-[#0F2944]/10 text-[#0F2944] text-xs rounded-full font-medium">
                    {firm.casesHandled}+ cases handled
                  </span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-xl">
                    <p className="text-3xl font-bold text-[#0F2944]">{firm.casesHandled}+</p>
