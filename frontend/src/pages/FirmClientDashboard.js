...
import { Scale, LogOut, User, Briefcase, Calendar, FileText, Clock, CheckCircle, MessageSquare, Phone, Mail, Building2, Bell, ChevronRight, Star } from 'lucide-react';
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                        event.type === 'hearing' ? 'bg-red-50 text-red-500' :
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <span className="text-sm text-gray-500">{dummyLawyer.rating} ({dummyLawyer.cases_won} cases)</span>
                    </div>
                  </div>
                </div>
