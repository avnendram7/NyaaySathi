        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-3xl shadow-2xl">
            <img
              ...
              style={{ 
                filter: 'brightness(1.3) contrast(1.6) saturate(2.2) hue-rotate(8deg) sepia(0.2)'
              }}
            />
            <div className="absolute inset-0 bg-gradient-to-br from-orange-400/25 via-red-300/20 to-yellow-300/15 mix-blend-overlay" />
          </div>
        </motion.div>
      ))}
    </>
