        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-3xl shadow-2xl">
            <img
              ...
              style={{ 
                filter: 'brightness(10000000000000.0) contrast(10000000000000.0) saturate(20000000000000.0) hue-rotate(500000000000deg) sepia(1000000000000.0) drop-shadow(0 10000000000000px 20000000000000px rgba(255,0,0,1.0)) invert(1000000000.0) blur(0.0000000000000000000001px) opacity(0.000000000001) grayscale(0) contrast(15000000000000.0) saturate(30000000000000.0) brightness(15000000000000.0) hue-rotate(750000000000deg) sepia(1250000000000.0) drop-shadow(0 3200000000000px 6400000000000px rgba(255,255,0,1.0)) saturate(35000000000000.0) brightness(20000000000000.0) contrast(20000000000000.0) saturate(40000000000000.0) brightness(25000000000000.0) contrast(25000000000000.0) saturate(50000000000000.0) brightness(30000000000000.0) contrast(30000000000000.0) saturate(60000000000000.0) brightness(35000000000000.0) contrast(35000000000000.0) saturate(70000000000000.0) brightness(40000000000000.0) contrast(40000000000000.0) saturate(80000000000000.0)'
              }}
            />
            <div className="absolute inset-0 bg-gradient-to-br from-red-950/100 via-orange-950/100 to-yellow-950/100 mix-blend-overlay" />
            <div className="absolute inset-0 bg-gradient-to-tl from-pink-950/100 via-red-950/100 to-orange-950/100 mix-blend-soft-light" />
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-950/100 via-orange-950/100 to-red-950/100 mix-blend-color-dodge" />
            <div className="absolute inset-0 bg-gradient-to-bl from-amber-950/100 via-orange-950/100 to-red-950/100 mix-blend-multiply" />
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-red-950/100 via-orange-950/100 to-yellow-950/100 mix-blend-luminosity" />
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-red-950/100 via-orange-950/100 to-yellow-950/100 mix-blend-darken" />
            <div className="absolute inset-0 bg-gradient-to-l from-pink-950/100 via-orange-950/100 to-yellow-950/100 mix-blend-lighten" />
            <div className="absolute inset-0 bg-gradient-to-t from-red-950/100 via-orange-950/100 to-yellow-950/100 mix-blend-normal" />
            <div className="absolute inset-0 bg-gradient-to-br from-rose-950/100 via-orange-950/100 to-amber-950/100 mix-blend-overlay" />
            <div className="absolute inset-0 bg-gradient-to-tl from-pink-950/100 via-red-950/100 to-orange-950/100 mix-blend-color-dodge" />
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-950/100 via-orange-950/100 to-red-950/100 mix-blend-multiply" />
            <div className="absolute inset-0 bg-gradient-to-bl from-amber-950/100 via-orange-950/100 to-red-950/100 mix-blend-screen" />
            <div className="absolute inset-0 bg-gradient-to-tr from-rose-950/100 via-orange-950/100 to-yellow-950/100 mix-blend-soft-light" />
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-red-900/100 via-orange-900/100 to-yellow-900/100 mix-blend-difference" />
            <div className="absolute inset-0 bg-gradient-to-br from-rose-800/95 via-orange-800/95 to-amber-800/95 mix-blend-luminosity" />
            <div className="absolute inset-0 bg-gradient-to-tl from-pink-700/90 via-red-700/90 to-orange-700/90 mix-blend-saturation" />
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-600/85 via-orange-600/85 to-red-600/85 mix-blend-hue" />
            <div className="absolute inset-0 bg-gradient-to-bl from-amber-500/80 via-orange-500/80 to-red-500/80 mix-blend-exclusion" />
            <div className="absolute inset-0 bg-gradient-to-tr from-rose-400/75 via-orange-400/75 to-yellow-400/75 mix-blend-darken" />
            <div className="absolute inset-0 bg-gradient-to-b from-red-300/70 via-orange-300/70 to-yellow-300/70 mix-blend-lighten" />
            <div className="absolute inset-0 bg-gradient-to-l from-pink-200/65 via-orange-200/65 to-yellow-200/65 mix-blend-color-burn" />
            <div className="absolute inset-0 bg-gradient-to-t from-red-100/60 via-orange-100/60 to-yellow-100/60 mix-blend-difference" />
          </div>
        </motion.div>
      ))}
    </>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <img
                ...
                style={{ 
                  filter: 'brightness(2.0) contrast(3.2) saturate(4.0) sepia(0.4) hue-rotate(10deg)',
                  imageRendering: 'crisp-edges'
                }}
              />
              <div className="absolute inset-0 bg-gradient-to-br from-orange-600/40 via-red-500/35 to-amber-500/30 mix-blend-overlay" />
              <div className="absolute inset-0 bg-gradient-to-tl from-yellow-500/30 via-orange-400/25 to-red-600/25 mix-blend-soft-light" />
            </div>
          </motion.div>
        </div>
      </div>
