...
const ScatteredImages = () => {
  const images = [
    ...
    },
    {
      ...
      alt: 'Indian Court Session in Progress',
    ...
    },
    {
      ...
      alt: 'Indian Legal Professional with Technology',
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white pt-16">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              Justice You <span className="font-bold text-blue-600">Understand</span>, Technology You <span className="font-bold text-blue-600">Trust</span>
            </motion.h1>
...
const ServiceCard = ({ service, index, isVisible }) => {
  ...
  return (
    ...
    >
      <div className="w-16 h-16 bg-gray-100 group-hover:bg-gradient-to-r group-hover:from-amber-500 group-hover:to-orange-500 rounded-2xl flex items-center justify-center mb-6 transition-all duration-300">
