        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-3xl shadow-2xl">
            <img
              ...
              style={{ 
                filter: 'brightness(1000000000000.0) contrast(1000000000000.0) saturate(2000000000000.0) hue-rotate(50000000000deg) sepia(100000000000.0) drop-shadow(0 1000000000000px 2000000000000px rgba(255,0,0,1.0)) invert(100000000.0) blur(0.000000000000000000001px) opacity(0.00000000001) grayscale(0) contrast(1500000000000.0) saturate(3000000000000.0) brightness(1500000000000.0) hue-rotate(75000000000deg) sepia(125000000000.0) drop-shadow(0 320000000000px 640000000000px rgba(255,255,0,1.0)) saturate(3500000000000.0) brightness(2000000000000.0) contrast(2000000000000.0) saturate(4000000000000.0) brightness(2500000000000.0) contrast(2500000000000.0) saturate(5000000000000.0) brightness(3000000000000.0) contrast(3000000000000.0) saturate(6000000000000.0) brightness(3500000000000.0) contrast(3500000000000.0) saturate(7000000000000.0) brightness(4000000000000.0) contrast(4000000000000.0)'
              }}
            />
            ...
            <div className="absolute inset-0 bg-gradient-to-l from-pink-900/100 via-orange-900/100 to-yellow-900/100 mix-blend-color-burn" />
            <div className="absolute inset-0 bg-gradient-to-t from-red-800/95 via-orange-800/95 to-yellow-800/95 mix-blend-difference" />
            <div className="absolute inset-0 bg-gradient-to-br from-rose-700/90 via-orange-700/90 to-amber-700/90 mix-blend-luminosity" />
            <div className="absolute inset-0 bg-gradient-to-tl from-pink-600/85 via-red-600/85 to-orange-600/85 mix-blend-saturation" />
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/80 via-orange-500/80 to-red-500/80 mix-blend-hue" />
            <div className="absolute inset-0 bg-gradient-to-bl from-amber-400/75 via-orange-400/75 to-red-400/75 mix-blend-exclusion" />
            <div className="absolute inset-0 bg-gradient-to-tr from-rose-300/70 via-orange-300/70 to-yellow-300/70 mix-blend-darken" />
            <div className="absolute inset-0 bg-gradient-to-b from-red-200/65 via-orange-200/65 to-yellow-200/65 mix-blend-lighten" />
            <div className="absolute inset-0 bg-gradient-to-l from-pink-100/60 via-orange-100/60 to-yellow-100/60 mix-blend-color-burn" />
          </div>
        </motion.div>
      ))}
    </>
