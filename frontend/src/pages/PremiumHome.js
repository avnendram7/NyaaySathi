        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-3xl shadow-2xl">
            <img
              src={image.src}
              alt={image.alt}
              className="w-full h-full object-cover brightness-140 contrast-140 saturate-200 hue-rotate-15"
            />
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/40 via-yellow-500/30 to-red-600/35" />
            <div className="absolute inset-0 bg-gradient-to-tl from-pink-500/25 via-purple-400/15 to-green-600/30" />
            <div className="absolute inset-0 bg-gradient-to-r from-amber-400/20 via-orange-300/25 to-red-400/20" />
            <div className="absolute inset-0 mix-blend-overlay bg-gradient-to-br from-yellow-300/30 to-orange-400/30" />
          </div>
        </motion.div>
      ))}
    </>
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-gray-600">Technology You Trust</span>
            </motion.h1>
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  ...
                  variant="outline"
                  className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white text-lg px-14 py-8 rounded-full font-semibold transition-all duration-300"
                >
                  Free AI Assistant
                </Button>
              </motion.div>
...
const ServiceCard = ({ service, fadeInUp }) => {
  ...
  return (
    ...
    >
      <div className="w-16 h-16 bg-gray-100 group-hover:bg-blue-600 rounded-2xl flex items-center justify-center mb-6 transition-all duration-300">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <img
                ...
                alt="Indian Legal Consultation - People Benefiting from Legal Services"
                className="w-full h-[500px] object-cover brightness-110 contrast-110 saturate-125"
              />
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              onClick={() => navigate('/role-selection')}
              className="bg-blue-600 hover:bg-blue-700 text-white text-lg px-12 py-7 rounded-full font-semibold shadow-2xl group"
            >
