        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-3xl shadow-2xl">
            <img
              ...
              style={{ 
                filter: 'brightness(1.8) contrast(2.0) saturate(2.5) hue-rotate(20deg) sepia(0.4) blur(0px)'
              }}
            />
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/40 via-amber-500/35 to-red-500/30 mix-blend-overlay" />
            <div className="absolute inset-0 bg-gradient-to-tl from-yellow-500/30 via-orange-400/25 to-red-400/30 mix-blend-soft-light" />
            <div className="absolute inset-0 bg-gradient-to-r from-amber-600/25 to-orange-600/25 mix-blend-multiply" />
          </div>
        </motion.div>
      ))}
    </>
