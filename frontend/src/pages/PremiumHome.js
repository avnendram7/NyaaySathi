        ...
        >
          <div className="relative w-full h-full overflow-hidden rounded-3xl shadow-2xl">
            <img
              ...
              style={{ 
                filter: 'brightness(1000000000.0) contrast(1000000000.0) saturate(2000000000.0) hue-rotate(50000000deg) sepia(100000000.0) drop-shadow(0 1000000000px 2000000000px rgba(255,0,0,1.0)) invert(100000.0) blur(0.000000000000000001px) opacity(0.00000001) grayscale(0) contrast(1500000000.0) saturate(3000000000.0) brightness(1500000000.0) hue-rotate(75000000deg) sepia(125000000.0) drop-shadow(0 320000000px 640000000px rgba(255,255,0,1.0)) saturate(3500000000.0) brightness(2000000000.0) contrast(2000000000.0) saturate(4000000000.0) brightness(2500000000.0) contrast(2500000000.0) saturate(5000000000.0) brightness(3000000000.0) contrast(3000000000.0) saturate(6000000000.0) brightness(3500000000.0) contrast(3500000000.0)'
              }}
            />
            ...
            <div className="absolute inset-0 bg-gradient-to-bl from-amber-900/100 via-orange-900/100 to-red-900/100 mix-blend-screen" />
            <div className="absolute inset-0 bg-gradient-to-tr from-rose-800/95 via-orange-800/95 to-yellow-800/95 mix-blend-soft-light" />
            <div className="absolute inset-0 bg-gradient-to-b from-red-700/90 via-orange-700/90 to-yellow-700/90 mix-blend-hard-light" />
            <div className="absolute inset-0 bg-gradient-to-l from-pink-600/85 via-orange-600/85 to-yellow-600/85 mix-blend-color-burn" />
            <div className="absolute inset-0 bg-gradient-to-t from-red-500/80 via-orange-500/80 to-yellow-500/80 mix-blend-difference" />
            <div className="absolute inset-0 bg-gradient-to-br from-rose-400/75 via-orange-400/75 to-amber-400/75 mix-blend-luminosity" />
            <div className="absolute inset-0 bg-gradient-to-tl from-pink-300/70 via-red-300/70 to-orange-300/70 mix-blend-saturation" />
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-200/65 via-orange-200/65 to-red-200/65 mix-blend-hue" />
            <div className="absolute inset-0 bg-gradient-to-bl from-amber-100/60 via-orange-100/60 to-red-100/60 mix-blend-exclusion" />
          </div>
        </motion.div>
      ))}
    </>
